...
const navItems = [
    {text: 'Pagina Principal', path: '/PaginaInicioAdministrador'},
    {text: 'Registrar Usuario', path: '/RegistrarUsuario'},
    {text: 'Modificar Usuario', path: '/ModificarUsuario'},
    {text: 'Estudiantes', path: '/HerramientasEstudianteAdministrador'},
...
export const Navbar1 = (props: Props) => {
    ...
    const drawer = (
        <Box onClick={handleDrawerToogle} sx={{textAlign: 'center'}}>
            {/* Reemplazo para la versión móvil (drawer) */}
            <Box 
                component="img"
                src={logo}
                alt="Logo Liceo La Siembra"
                sx={{
                    height: 60, // Ajusta según el tamaño de tu logo
                    width: 'auto',
                    my: 2,
                    mx: 'auto'
                }}
        ...
        <Box sx={{display: 'flex'}}>
            ...
            <AppBar component='nav' sx={{bgcolor: 'gray'}}>
                <Toolbar>
                    ...
                    {/* Reemplazo para la versión de escritorio */}
                    <Box 
                        component="img"
                        src={logo}
                        alt="Logo Liceo La Siembra"
