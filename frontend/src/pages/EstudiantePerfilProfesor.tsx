...
import { PictureAsPdf, ListAlt, ArrowBack } from '@mui/icons-material';
import { useNavigate } from 'react-router-dom';
import estudianteFoto from '../assets/usuario.png';
import { Navbar2 } from '../components';

const EstudiantePerfilProfesor = () => {
  ...
  const handleGenerarPDF = () => {
    console.log("Generando PDF de calificaciones promedio...");
  };

  const handleVerCalificaciones = () => {
    navigate(`/calificaciones-estudiante/${estudiante.cedula}`);
  };
      ...
      <Container maxWidth="sm" sx={{ 
        ...
        <Paper elevation={4} sx={{ 
          ...
          <Box sx={{ 
            ...
            >
              Generar PDF de calificaciones promedio
            </Button>

            <Button
              variant="contained"
              startIcon={<ListAlt />}
              onClick={handleVerCalificaciones}
              sx={{
                py: 1.5,
                borderRadius: '8px',
...
export default EstudiantePerfilProfesor;